elem_text = elem_text.concat([
  ...
  ['#begin_li3',
    'Your "Customers List" and "Item List" will be stored as a link - you will understand more if you are done creating the first one',
    '"รายชื่อลูกค้า" และ "รายการสินค้า" ของคุณจะถูกเก็บไว้เป็นแบบลิงค์ - คุณจะเข้าใจมากขึ้นหากคุณสร้างเอกสารใบแรกเสร็จแล้ว',
  ],
  ['#begin_li4',
